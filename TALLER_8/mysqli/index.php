...
/**
 * Construye los enlaces de paginación para una sección.
 *
...
<head>
    ...
    <style>
        ...
        header { background: #0b3d91; color: #fff; padding: 1rem; }
        header h1 { margin: 0; }
        ...
        button { background: #0b3d91; color: #fff; border: none; padding: 0.5rem 1rem; border-radius: 4px; cursor: pointer; }
        button:hover { background: #09407f; }
        table { width: 100%; border-collapse: collapse; }
        th, td { border: 1px solid #ddd; padding: 0.5rem; text-align: left; }
        th { background: #f0f0f0; }
        .messages, .errors { margin: 1rem; padding: 0.5rem 1rem; border-radius: 4px; }
        .messages { background: #e0f7e9; color: #1b5e20; }
        ...
        .pagination .current { padding: 0.3rem 0.6rem; border-radius: 3px; background: #0b3d91; color: #fff; }
